...
curl -sL https://raw.githubusercontent.com/cpunivangers/madeb12/main/files/update_madeb12.sh > /tmp/update_madeb12.sh
...
# playbook mini deb12
ansible-playbook tplinux.yml -i localhost, -c local
